 ...
 */
package com.sap.migration.core.constants;

/**
 * Global class for all MigrationCore constants. You can add global constants for your extension into this class.
 */
public final class MigrationCoreConstants extends GeneratedMigrationCoreConstants
{
	public static final String EXTENSIONNAME = "migrationcore";


	private MigrationCoreConstants()
	{
		//empty
	}
