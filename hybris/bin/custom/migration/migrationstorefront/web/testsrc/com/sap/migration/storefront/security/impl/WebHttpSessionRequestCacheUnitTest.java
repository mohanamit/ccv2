...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/migrationstorefront/electronics/en",
						"https://electronics.local:9002/migrationstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/migrationstorefront/electronics/en",
						"https://electronics.local:9002/migrationstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/migrationstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/migrationstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/migrationstorefront/electronics/en",
						"https://electronics.local:9002/migrationstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/migrationstorefront",
						"https://electronics.local:9002/migrationstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/migrationstorefront",
						"https://electronics.local:9002/migrationstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/migrationstorefront/electronics/en",
						"https://electronics.local:9002/migrationstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
