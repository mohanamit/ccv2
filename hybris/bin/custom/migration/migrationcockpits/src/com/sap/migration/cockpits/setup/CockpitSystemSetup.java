 ...
 */
package com.sap.migration.cockpits.setup;
...
import com.sap.migration.cockpits.constants.MigrationCockpitsConstants;
 ...
 */
@SystemSetup(extension = MigrationCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MigrationCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MigrationCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MigrationCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/migrationcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
