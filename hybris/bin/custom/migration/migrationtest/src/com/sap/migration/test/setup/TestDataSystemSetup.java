 ...
 */
package com.sap.migration.test.setup;
...
import com.sap.migration.test.constants.MigrationTestConstants;
import com.sap.migration.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MigrationTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/migrationtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/migrationtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/migrationtest/import/cstickets.impex");
			...
			importImpexFile(context, "/migrationtest/import/csquotes.impex");
		}
	}
}
