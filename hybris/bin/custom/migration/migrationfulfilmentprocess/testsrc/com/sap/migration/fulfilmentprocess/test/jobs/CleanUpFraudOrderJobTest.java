 ...
 */
package com.sap.migration.fulfilmentprocess.test.jobs;
...
import com.sap.migration.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MigrationFulfilmentProcessConstants.ORDER_PROCESS_NAME;
