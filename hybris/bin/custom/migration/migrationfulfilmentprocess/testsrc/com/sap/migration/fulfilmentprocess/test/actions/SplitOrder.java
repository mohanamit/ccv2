 ...
 */
package com.sap.migration.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MigrationFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MigrationFulfilmentProcessConstants.PARENT_PROCESS);
